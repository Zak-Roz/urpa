export default class Poa {
  constructor(property, principal_name, is_duplicate, expiry_date, certification_date, blank_number, blank_series, confident_code, confident_name, principal_code) { // , passportSeries, passportNumber, passportIssueDate, passportAuthority, rntrc
